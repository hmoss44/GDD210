...
private float hP3 = 10;
private float hP4 = 20;
...
if(Input.GetMouseButtonDown(0))
		{
			RaycastHit hit;
			    ...
			    {
						// Debug.DrawLine(tranfsorm.poistion, hit.)
					...
					if(hit.collider.gameObject.name == "target3")
                    {
						hP3--;
						if(hP3==0)
						{
					...
					if(hit.collider.gameObject.name == "target4")
                    {
						hP4--;
						if(hP4==0)
						{
